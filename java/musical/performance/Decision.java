 ...
 * <p/>
 * This is a highly abstract conceptual interface used for bringing data types that represent human active preferences under one umbrella.
...
extends
    Group,
    musical.performance.system.Type<Interaction.Conversion<?,?,?,?>>,
    Unit
{}