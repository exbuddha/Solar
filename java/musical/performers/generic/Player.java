...
import musical.performance.Instruction;
import musical.performance.Interpreted;
import musical.performance.Performer;
import musical.performance.Interaction.Physical.Performance;
import musical.performance.system.Type;
...
extends Performer<MusicalInstrument>
{
    ...
    @Override
    public musical.performance.State apply(musical.performance.State t, Class<? extends Type<Performance>> u) { return null; }

    @Override
    public Iterable<? extends Instruction> perform(musical.performance.Snapshot.Instance<?> situation, Interpreted event) { return null; }
