...
[Conductor](https://github.com/exbuddha/Solar/blob/master/java/performance/Conductor.java) through the use the `Score.Conductor` and the data structured in the available `Conductor.Coordination` class prepares an `Conductor.Orchestration` type. This confirms `Orchestration` being a subclass of `Coordination`.
